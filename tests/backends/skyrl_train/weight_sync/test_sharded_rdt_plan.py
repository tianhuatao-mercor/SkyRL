...
def _copy(name, layer_param="weight", *, offset=0, shape=(4,), ops=(), layer=None, dtype=torch.bfloat16):
...
def _router(num_producers, num_consumers, owner_sets=None, name_owner_class=None, names=None, group_lens=None):
...
class TestReplicaOverlay:
    ...
    def _fleet(self, num_producers, workers, replicas, owner_sets=None, name_owner_class=None, n_names=6):
    ...
    def test_a_width_that_does_not_divide_the_fleet_raises(self):
        ...
        block index, so refuse rather than mis-serve."""
